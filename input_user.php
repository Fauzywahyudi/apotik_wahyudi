...
<div class="dh6" align='center'>
<b>Nama Lengkap</b><h3><input type="text" name="nama" value="" placeholder="Nama Lengkap"></h3><br>
<b>Pekerjaan</b><h3><input type="text" name="pekerjaan" value="" placeholder="Pekerjaan"></h3><br>
</div>
...
if(isset($_POST["simpan"])){
  ...
  if($r == 0){
  $sqlm = mysqli_query($kon, "insert into tbl_user (username, password, nama, pekerjaan, tglreg) values ('$_POST[username]', '$_POST[password]', '$_POST[nama]', '$_POST[pekerjaan]', NOW())");
