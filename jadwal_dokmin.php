  ...
  if ($num>0) {
    ...
    while ($rm=mysqli_fetch_array($sqlm)) {
      ...
      echo "<tr>
        ...
        <td align='center'><a href=damin.php?p=editjadmin&user=$rm[user_dokter]&kode=$rm[kd_jadwal] '><button type='button' class='btn btn-edit'>Detail</button></a>
        </td>
      </tr>";
      echo " <tr>
            <td colspan=7><hr color='#5271FF'> </td>
...
if (isset($_POST['kembali'])) {
  ...
  echo "<META HTTP-EQUIV='Refresh' Content='1; URL=damin.php?p=profildokmin&user=$_GET[user]'>";
}
 ?>
