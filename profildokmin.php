<?php
$sqlmhs=mysqli_query($kon,"select * from tbl_dokter where username='$_GET[user]'");
...
<div class="dh3" align='center'>
  ...
  echo " ";
  echo "<a href='damin.php?p=dokter'><button type='button' class='btn btn-edit'>Kembali</button></a>";
   ?>

</div>
<div class="dh4">
Nama Lengkap <h3><?php echo "$rmhs[nama]"; ?></h3>
Spesialis <h3><?php echo "$rmhs[pekerjaan]"; ?></h3>
<?php
  echo "<a href='dokterhapus.php?user=$rmhs[username]'><button type='button' class='btn btn-hapus'>Hapus</button></a>
  <a href='damin.php?p=dok_edit&user=$rmhs[username]'><button type='button' class='btn btn-edit'>Edit</button></a>
  <a href='damin.php?p=jadwal_dokmin&user=$rmhs[username]'><button type='button' class='btn btn-edit'>Lihat Jadwal</button></a>"
  ; 
  ?>
