...
if($jml=="$_GET[hal]"){
			...
			<?php
			echo "<META HTTP-EQUIV='Refresh' Content='1; URL=?p=hasilkonsultasifc&gjl=$gjl'>";


			}
			if (isset($_POST['btn_tidak'])) {
				echo "<META HTTP-EQUIV='Refresh' Content='1; URL=?p=hasilkonsultasifc&gjl=$_GET[gjl]'>";
		...
		$sqlins=mysqli_query($kon,"insert into fakta_baru values ('$id','$nama','$jenis','$ket')");
		echo "<META HTTP-EQUIV='Refresh' Content='0.5; URL=?p=konsultasifc&hal=$hal&gjl=$gjl'>";


		}
		if (isset($_POST['btn_tidak'])) {
			echo "<META HTTP-EQUIV='Refresh' Content='0.5; URL=?p=konsultasifc&hal=$hal&gjl=$_GET[gjl]'>";
